...
class VideoFramesAdmin(admin.ModelAdmin):
    ...
    list_filter = ('video__file_name', 'has_frames_60', 'total_frames_60', 'has_frames_4', 'total_frames_4', 'video_frames_total', 'frame_folder_path', 'frame_folder_path_4', 'frame_folder_path_60')
