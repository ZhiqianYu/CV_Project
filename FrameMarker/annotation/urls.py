...
urlpatterns = [
    ...
    path('update_overlay/<int:video_id>/<str:frame_type>/<int:frame_number>/', views.update_overlay, name='update_overlay'),
    path('subframe_overlay/<int:video_id>/<str:frame_type>/<int:frame_number>/', views.subframe_overlay, name='subframe_overlay'),
