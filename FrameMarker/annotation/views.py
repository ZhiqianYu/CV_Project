...
def annotation(request, video_id):
    ...
    for frame_path_60 in frame_paths_60_orig:
        ...
        frame_paths_60 = frame_paths_60 + [frame_path_60_rel]
        #frame_paths_60.append(frame_path_60_rel) #= frame_paths_60 + [frame_path_60_rel]
    
    #print('frame_folder_4:', frame_folder_4)
    print('frame_folder_60:', frame_folder_60)
