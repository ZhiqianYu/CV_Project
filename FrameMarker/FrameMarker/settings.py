"""
    ...
    Introduction of this file:
        This file is the main settings.py file of the project. It is responsible to register the apps in the project. 
        Set the static files and media files path. Set the database. Set the timezone. Set the login redirect url.
"""
...
SECRET_KEY = 'django-insecure-05j$vg1-ye&8v7lp+-#w1r^$c4ij6h!hi!21*ltr1@l_5^5#-l'
...
WSGI_APPLICATION = 'FrameMarker.wsgi.application'
